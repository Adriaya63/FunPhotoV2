...
public class GetUserImagesWorker extends Worker {

    public GetUserImagesWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String url = "http://34.175.199.167:81/cogerFotosUsuario.php?usuario=" + nombreUsuario;
