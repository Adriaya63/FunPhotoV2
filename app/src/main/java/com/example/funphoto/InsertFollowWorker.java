...
public class InsertFollowWorker extends Worker {

    public InsertFollowWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String url = "http://34.175.199.167:81/insert_follow.php";
